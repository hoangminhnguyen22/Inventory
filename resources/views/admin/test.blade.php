...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="{{URL::asset('assets')}}/css/ui.jqgrid.min.css" />
									...
									<ul class="dropdown-menu dropdown-navbar">
										<li>
											<a href="#" class="clearfix">
												<img src="{{URL::asset('assets')}}/images/avatars/avatar.png" class="msg-photo" alt="Alex's Avatar" />
												<span class="msg-body">
										...
										<li>
											<a href="#" class="clearfix">
												<img src="{{URL::asset('assets')}}/images/avatars/avatar3.png" class="msg-photo" alt="Susan's Avatar" />
												<span class="msg-body">
													<span class="msg-title">
										...
										<li>
											<a href="#" class="clearfix">
												<img src="{{URL::asset('assets')}}/images/avatars/avatar4.png" class="msg-photo" alt="Bob's Avatar" />
												<span class="msg-body">
													<span class="msg-title">
										...
										<li>
											<a href="#" class="clearfix">
												<img src="{{URL::asset('assets')}}/images/avatars/avatar2.png" class="msg-photo" alt="Kate's Avatar" />
												<span class="msg-body">
													<span class="msg-title">
										...
										<li>
											<a href="#" class="clearfix">
												<img src="{{URL::asset('assets')}}/images/avatars/avatar5.png" class="msg-photo" alt="Fred's Avatar" />
												<span class="msg-body">
													<span class="msg-title">
...
<![endif]-->
		...
		<script src="{{URL::asset('assets')}}/js/jquery.jqGrid.min.js"></script>
		<script src="{{URL::asset('assets')}}/js/grid.locale-en.js"></script>
