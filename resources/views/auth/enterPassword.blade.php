								...
								<div id="forgot-box" class="forgot-box visible widget-box no-border">
									<div class="widget-body">
										<div class="widget-main">
											...
											<div class="space-6"></div>
											<p>
												Enter your password to login into account
											</p>
												...
												<fieldset>
                                                    <label class="block clearfix">
														<span class="block input-icon input-icon-right">
                                                            @php
                                                                $email = session('email')
                                                                // ở đây mình có thể dùng session bth thay vì flash và hủy sau khi dùng xong để có thể load trang vẫn có sesion
                                                            @endphp
                                                    ...
                                                    <label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="password" name="re-password" class="form-control" placeholder="Enter password again" />
															<i class="ace-icon fa fa-key"></i>
														</span>
													</label>
													@error('re-password')
