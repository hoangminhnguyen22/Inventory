								...
								<div id="login-box" class="login-box 
									...
									<div class="widget-body">
										<div class="widget-main">
											...
											<form action="{{route('auth.logstore')}}" method="post">
                                                @csrf
												<fieldset>
										...
										<div class="toolbar clearfix">
											<div>
												<a href="{{route('auth.forgot')}}" {{--data-target="#forgot-box"--}} class="forgot-password-link">
											...
											<div>
												<a href="{{route('auth.register')}}" {{--data-target="#signup-box"--}} class="user-signup-link">
													I want to register
								...
								<div id="signup-box" class="signup-box 
									...
									<div class="widget-body">
										<div class="widget-main">
											...
											<form action="{{route('auth.regstore')}}" method="post">
												@csrf
												<fieldset>
													...
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="password" name="re-password" class="form-control" placeholder="Repeat password" />
